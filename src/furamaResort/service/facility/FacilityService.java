package furamaResort.service.facility;
...
import furamaResort.repository.facility.FacilityRepository;
import furamaResort.repository.facility.IFacilityRepository;
...
public class FacilityService implements IFacilityService {
    ...
    @Override
    public void getAll() {
        Map<Facility, Integer> facilityMap = repository.getAll();
    ...
    public void getAllMaintenance() {
        Map<Facility, Integer> maintenance = repository.getAllMaintenance();
